#!/bin/bash
#SBATCH -J sd15_lora_train_320_noclip
#SBATCH -A cdac
#SBATCH -p standard
#SBATCH -N 1
#SBATCH --gres=gpu:1
...
export OUT_DIR="$BASE_DIR/sd_training/sd1.5/outputs_l320_5000steps_unetonly"
export CKPT_DIR="$BASE_DIR/sd_training/sd1.5/checkpoints_l320_5000steps_unetonly"
...
# ------------------------------ Launch Training -------------------------------
echo "[INFO] Launching SD 1.5 LORA training (UNet only, no CLIP encoder) with Accelerate..."
