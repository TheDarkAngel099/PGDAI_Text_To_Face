#!/usr/bin/env python3
"""
Generate images using the trained RealVizXL LoRA model and captions from test_captions.jsonl
"""
...
CHECKPOINT_DIR = "/home/dai01/Text_To_Face/sd_training/outputs_l320_3epochs_const_clip"
...
parser = argparse.ArgumentParser(description="Generate images using trained RealVizXL LoRA model")
parser.add_argument("checkpoint", type=str, 
                    help="Checkpoint to use (e.g., checkpoint-450, checkpoint-1800, checkpoint-2700)")
...
if not args.checkpoint:
    print("[ERROR] Please specify a checkpoint: python3 generate_images_from_captions.py checkpoint-2700")
    sys.exit(1)
...
if args.output_dir:
    ...
    OUTPUT_DIR = os.path.join("/home/dai01/Text_To_Face/infer_test", f"generated_realvizxl_{args.checkpoint}")
...
for idx, caption_data in enumerate(captions_to_process, 1):
    ...
    image_name = caption_data.get('file_name', caption_data.get('image', f'image_{idx}'))
    ...
    negative_prompt_embeds, negative_pooled_prompt_embeds = compel(args.negative_prompt)
